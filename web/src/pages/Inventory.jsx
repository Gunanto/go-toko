    ...
    <>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-soft-xl lg:col-span-2">
          <h2 className="text-lg font-semibold text-gray-900">Mutasi Terbaru</h2>
          <div className="mt-4 space-y-3">
            {movements.map((move) => (
              ...
              >
                <div>
                  <p className="text-sm font-semibold text-gray-900">{move.item}</p>
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-500">{move.type}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-soft-xl">
          <h2 className="text-lg font-semibold text-gray-900">Jadwal Restock</h2>
          <div className="mt-4 space-y-3 text-sm text-gray-600">
            <div className="rounded-xl border border-gray-100 px-3 py-3">
              <p className="font-semibold text-gray-900">Supplier Utama</p>
