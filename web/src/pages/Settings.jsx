    ...
    <>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-soft-xl">
          <h2 className="text-lg font-semibold text-gray-900">Profil Toko</h2>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-soft-xl">
          ...
          <div className="mt-4 space-y-3 text-sm text-gray-600">
            <div className="flex items-center justify-between rounded-xl border border-gray-100 px-3 py-3">
              <div>
                <p className="font-semibold text-gray-900">PPN</p>
            ...
            <div className="flex items-center justify-between rounded-xl border border-gray-100 px-3 py-3">
              <div>
                <p className="font-semibold text-gray-900">Biaya Layanan</p>
